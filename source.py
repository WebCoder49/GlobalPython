...
# Funciónes
función
preguntar_nombre(quien):
nombre = preguntar("¿Qué es el nombre de " + quien + "?")
devolver
nombre

función
preguntar_edad_en_meses(quien):
...
# Aritmética
a = 1 + 2 * 3 == (7).parte_real()
y(1 == 0.4 + 0.3 * 0.2).parte_real() == 1  # Verdadero
